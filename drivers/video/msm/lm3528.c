...
static char *DEVICE_VERSION_3630 = "3630";
static char *DEVICE_VERSION_3528 = "3528";
...
exit:
    ...
    {
        lm3528_client = 0;
        bk_device_3528 = false;
		register_device_proc("backlight", DEVICE_VERSION_3630, DEVICE_MANUFACUTRE);
        gpio_free(LM_ENABLE_GPIO);
    }
    else
    {
        bk_device_3528=true;
		register_device_proc("backlight", DEVICE_VERSION_3528, DEVICE_MANUFACUTRE);
    }
    return rc;
